...
public class AJ_FruitStand {
    ...
    public static void main(String[] args) {
        ...
        AJ_Fruit frtFruit1 = new AJ_Fruit();                     // creates a basic - generic fruit;
        AJ_Fruit frtFruit2 = new AJ_Fruit("Apple");   // creates fruit with a known name;
        AJ_Fruit frtFruit3 = new AJ_Fruit("Banana","Green");     // uses a different constructor;
